...
public class SqlBasicCall extends SqlCall {
  ...
  protected SqlBasicCall(
    ...
    this(operator, operands, pos, expanded, functionQualifier, SqlNodeList.EMPTY);
  }
  ...
  @Override public SqlNode clone(SqlParserPos pos) {
    return getOperator().createCall(getFunctionQuantifier(), getAggOrderList(), pos, operands);
  }
