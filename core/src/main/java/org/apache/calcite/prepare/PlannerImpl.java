...
public class PlannerImpl implements Planner, ViewExpander {
  ...
  private SqlValidator createValidator(SqlConformance conformance,
    ...
    SqlValidatorFactory factory = connectionConfig.validatorFactory(SqlValidatorFactory.class,
        CalciteSqlValidator.FACTORY);
  ...
  private SqlToRelConverter createSqlToRelConverter(Prepare.CatalogReader catalogReader,
    ...
    SqlToRelConverterFactory factory = connectionConfig.sqlToRelConverterFactory(
        SqlToRelConverterFactory.class, SqlToRelConverter.FACTORY);
  ...
  private Prepare.CatalogReader createCatalogReader() {
    ...
    CatalogReaderFactory factory = connectionConfig.catalogReaderFactory(
        CatalogReaderFactory.class, CalciteCatalogReader.FACTORY);
