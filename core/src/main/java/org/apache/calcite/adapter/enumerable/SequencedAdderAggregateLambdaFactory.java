...
/**
 * Generate aggregate lambdas that apply a sequence of accumulator adders to input source.
 *
 ...
 */
public class SequencedAdderAggregateLambdaFactory<TSource, TAccumulate, TResult, GroupByKey>
    implements AggregateLambdaFactory<TSource, TAccumulate, TAccumulate, TResult, GroupByKey> {
  ...
  @Override public Function2<GroupByKey, TAccumulate, TResult> resultSelector(
