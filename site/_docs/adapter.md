...
| <a href="{{ site.apiRoot }}/org/apache/calcite/config/CalciteConnectionProperty.html#VALIDATOR_FACTORY">validatorFactory</a> | SQL validator factory. The name of a class that implements [<code>interface SqlValidatorFactory</code>]({{ site.apiRoot }}/org/apache/calcite/sql/validate/SqlValidatorFactory.html) and has a public default constructor or an `INSTANCE` constant.
| <a href="{{ site.apiRoot }}/org/apache/calcite/config/CalciteConnectionProperty.html#CATALOG_READER_FACTORY">catalogReaderFactory</a> | Catalog reader factory. The name of a class that implements [<code>interface CatalogReaderFactory</code>]({{ site.apiRoot }}/org/apache/calcite/prepare/CatalogReaderFactory.html) and has a public default constructor or an `INSTANCE` constant.
| <a href="{{ site.apiRoot }}/org/apache/calcite/config/CalciteConnectionProperty.html#SQL_TO_REL_CONVERTER_FACTORY">sqlToRelConverterFactory</a> | SQL-to-rel converter factory. The name of a class that implements [<code>interface SqlToRelConverterFactory</code>]({{ site.apiRoot }}/org/apache/calcite/sql2rel/SqlToRelConverterFactory.html) and has a public default constructor or an `INSTANCE` constant.
